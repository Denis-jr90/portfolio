  ...
  return (
    <>
      ...
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-black text-white p-8 rounded-2xl border border-gray-800"
              >
        ...
        {/* CONTACT */}
        <section id="contact" className="py-20 px-6 md:px-10 bg-gray-900">
          <h2 className="text-4xl font-bold mb-8 text-cyan-400">
            Contact Me
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 max-w-2xl">
            ...
            <button
              type="submit"
              className="bg-cyan-500 hover:bg-cyan-600 px-8 py-4 rounded-xl text-black font-bold"
            >
              Send Message
            </button>
          </form>
        ...
        {/* ADMIN */}
        <section id="admin" className="py-20 px-6 md:px-10">
          <h2 className="text-4xl font-bold mb-8 text-cyan-400">
            Admin Panel
          </h2>
